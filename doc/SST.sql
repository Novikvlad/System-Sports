...
CREATE TABLE "user_account" (
	...
	"country_id" int NOT NULL,
	"fun_organisation_id" bigint NOT NULL,
...
CREATE TABLE "partner_contract" (
	...
	"contract" DECIMAL(12,2) NOT NULL,
	"created" TIMESTAMP NOT NULL,
	"updated" TIMESTAMP NOT NULL,
...
CREATE TABLE "player_id_2_statistic" (
	"player_attribute_id" int NOT NULL,
...
ALTER TABLE "club_2_owner_id" ADD CONSTRAINT "club_2_owner_id_fk0" FOREIGN KEY ("user_account_id") REFERENCES "user_account"("id");
ALTER TABLE "club_2_owner_id" ADD CONSTRAINT "club_2_owner_id_fk1" FOREIGN KEY ("club_id") REFERENCES "club"("id");
...
ALTER TABLE "player_id_2_statistic" ADD CONSTRAINT "player_id_2_statistic_fk0" FOREIGN KEY ("statistic_id") REFERENCES "statistic"("id");
