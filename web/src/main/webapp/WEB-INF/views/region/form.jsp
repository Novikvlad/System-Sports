...
<h4 class="header"><mytaglib:i18n key="edit.region"/></h4>
<div class="row">
	<form:form class="col s12" method="POST" action="${pagesRegion}"
		...
		<div class="row">
			...
			<div class="col s3">
				<a class="btn waves-effect waves-light right" href="${pagesRegion}"><mytaglib:i18n key="toList"/><i class="material-icons right"></i>
				</a>
			</div>
		</div>
	</form:form>
